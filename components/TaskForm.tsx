    ...
    <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="relative">
          <input
            ...
            type="text"
            onKeyDown={(e) => {
              // Проверка на клавишу Enter (код клавиши 13)
              if (e.key === 'Enter') {
                onAddTag(); // Выполняем то же действие, что и при нажатии на кнопку
                e.preventDefault(); // Предотвращаем стандартное поведение (например, отправка формы)
              }
